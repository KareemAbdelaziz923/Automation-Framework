...
public class EmployeePage extends PageObject {
	...
	public static Target EMPLOYEEMENU = Target.the("employee menu").locatedBy("//*[@id='collapseSubItems4']/li[6]/a/span");
	public static Target ADD_EMPLOYEE = Target.the("add employee").locatedBy("//a[contains(text(),'Add User')]");
