...
public class VerifierPage extends PageObject {
	
	public static Target VERIFIERMENU = Target.the("verifier menu").locatedBy("//span[contains(text(),'Verifiers')]");
	public static Target ADD_VERIFIER = Target.the("add verifier").locatedBy("//a[contains(text(),'Add User')]");
	...
	public static Target ROLE = Target.the("role").locatedBy("//select[@name='sub_role_id[]']");
